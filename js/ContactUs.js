...
const RECAPTCHA_SITEKEY = "6Lfyi48UAAAAALdKAOKVWEXLfdfB1FrM3UoTfr_R";
const FORM_CONTRACT = {"FIELDS":[{"key":"name","required":true,"parts":{"given":["first_name","firstname","fname","given_name"],"family":["last_name","lastname","surname","lname","family_name"]},"whole":["username","name","fullname","full_name","your_name","contact_name"]},{"key":"emailaddress","required":true,"aliases":["emailaddress","email","email_address","e_mail","your_email"]},{"key":"telephone","required":true,"aliases":["telephone","phone","tel","mobile","cell","phone_number","contact_number"]},{"key":"sendermessage","required":true,"aliases":["sendermessage","message","enquiry","inquiry","comments","comment","your_message"]},{"key":"service","required":false,"aliases":["service","subject","department","service_type","interest"]}],"HONEYPOT":"website"}; // { FIELDS: [...], HONEYPOT: "website" }
